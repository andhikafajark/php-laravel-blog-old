...
abstract class Repository
{
    ...
    protected function __getAll(FilterDomain $filterDomain): array
    {
        ...
        if ($filterDomain->orderColumn && $filterDomain->orderDirection) {
            $builder = $this->__filterOrder($builder, $filterDomain->orderColumn, $filterDomain->orderDirection);
        }
     ...
     * @return mixed
     */
    protected function __filterOrder($builder, ?string $orderColumn, ?string $orderDirection): mixed
    {
        if ($orderColumn && in_array($orderColumn, $this->allColumnOrder) && $orderDirection && in_array($orderDirection, $this->allOrderType)) {
